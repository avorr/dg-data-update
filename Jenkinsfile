...
//                 PORTAL_TOKEN_PD15 = credentials('PORTAL_TOKEN_PD15')
            ...
            agent {
                dockerfile {
                    ...
                    args '--rm --name docker-forticlient --privileged --net host --env-file ${WORKDIR}/.env_PD20 -e HOST=37.18.109.130:18443 -e LOGIN=${FORTI_CRED_USR} -e PASSWORD=${FORTI_CRED_PSW}'
                }
            }
            steps {
//                 sh "echo ${env}"
